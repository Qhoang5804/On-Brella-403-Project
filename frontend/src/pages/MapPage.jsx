  ...
  return (
    <div className="map-container relative h-[100dvh] bg-background-dark">
      ...
      <div className="absolute top-12 left-0 right-0 px-4 z-10">
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg flex items-center p-3 border border-slate-100 dark:border-slate-700">
          ...
          <input
            ...
            className="bg-transparent border-none focus:ring-0 text-sm w-full font-medium text-slate-900 dark:text-white placeholder-slate-400"
          />
        </div>
        {error && (
