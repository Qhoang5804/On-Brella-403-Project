...
class OpenAPIConverter {
     ...
     * @param environment
     */
    async convertToOpenAPIV3(environment, prettify = false) {
        ...
        const openAPIEnvironment = {
            ...
            paths: routes.reduce((paths, route) => {
                if (route.type !== commons_1.RouteType.HTTP) {
                    return paths;
                }
                ...
                paths[endpoint][route.method] = {
                    ...
                    responses: route.responses.reduce((responses, routeResponse) => {
                        ...
                        if (routeResponse.bodyType === commons_1.BodyTypes.INLINE &&
                            routeResponse.body) {
                            try {
    ...
    convertFromOpenAPIV3(parsedAPI, port) {
        ...
        if ((_a = server === null || server === void 0 ? void 0 : server[0]) === null || _a === void 0 ? void 0 : _a.url) {
            ...
            if (url.startsWith('/')) {
                newEnvironment.endpointPrefix = (0, commons_1.RemoveLeadingSlash)(url);
            }
            else {
                try {
                    const parsedUrl = new URL(url);
                    newEnvironment.endpointPrefix = (0, commons_1.RemoveLeadingSlash)(parsedUrl.pathname);
                }
                catch (error) {
                    // fail silently
                }
        ...
        Object.keys(parsedAPI.paths).forEach((routePath) => {
            Object.keys(parsedAPI.paths[routePath]).forEach((routeMethod) => {
                ...
                if (routeMethod in commons_1.Methods) {
                    ...
                    const newRoute = Object.assign(Object.assign({}, (0, commons_1.BuildHTTPRoute)(false)), { documentation: parsedRoute.summary || parsedRoute.description || '', method: routeMethod, endpoint: (0, commons_1.RemoveLeadingSlash)(this.v2ParametersReplace(routePath)), responses: routeResponses });
        ...
        if (responseHeaders) {
            return [
                ...
                ...Object.keys(responseHeaders).map((headerName) => {
                    ...
                    return (0, commons_1.BuildHeader)(headerName, headerValue);
                })
            ];
        }
