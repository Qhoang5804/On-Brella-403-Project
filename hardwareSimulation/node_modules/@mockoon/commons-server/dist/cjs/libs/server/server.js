...
class MockoonServer extends events_1.EventEmitter {
    constructor(environment, options = { envVarsPrefix: commons_1.defaultEnvironmentVariablesPrefix }) {
        super();
            ...
            request.on('end', () => {
                ...
                try {
                    if (requestContentType) {
                        if ((0, utils_1.stringIncludesArrayItems)(common_constants_1.ParsedJSONBodyMimeTypes, requestContentType)) {
    ...
    createRouteHandler(route, requestNumber, crudId) {
        return (request, response, next) => {
            ...
            const enabledRouteResponse = new response_rules_interpreter_1.ResponseRulesInterpreter(currentRoute.responses, request, currentRoute.responseMode, this.environment, this.processedDatabuckets, this.globalVariables, this.options.envVarsPrefix).chooseResponse(requestNumber);
