...
import { BodyTypes, BuildEnvironment, BuildHeader, BuildHTTPRoute, BuildRouteResponse, GetRouteResponseContentType, INDENT_SIZE, Methods, RemoveLeadingSlash, RouteType } from '@mockoon/commons';
        ...
        if ((_a = server === null || server === void 0 ? void 0 : server[0]) === null || _a === void 0 ? void 0 : _a.url) {
            ...
            if (url.startsWith('/')) {
                ...
                try {
                    ...
                    newEnvironment.endpointPrefix = RemoveLeadingSlash(parsedUrl.pathname);
                }
                catch (error) {
                    // fail silently
                }
        ...
        Object.keys(parsedAPI.paths).forEach((routePath) => {
            Object.keys(parsedAPI.paths[routePath]).forEach((routeMethod) => {
                ...
                if (routeMethod in Methods) {
                    ...
                    const newRoute = Object.assign(Object.assign({}, BuildHTTPRoute(false)), { documentation: parsedRoute.summary || parsedRoute.description || '', method: routeMethod, endpoint: RemoveLeadingSlash(this.v2ParametersReplace(routePath)), responses: routeResponses });
