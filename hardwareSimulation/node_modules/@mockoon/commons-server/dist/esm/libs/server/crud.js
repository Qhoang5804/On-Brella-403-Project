 ...
 */
export const databucketActions = (crudId, databucket, request, response, routeCrudKey) => {
    ...
    switch (crudId) {
        case 'get': {
            ...
            if (Array.isArray(responseBody)) {
                ...
                responseBody = responseBody.filter((r) => filters.every((f) => applyFilter(r, f)));
        ...
        case 'create': {
            if (Array.isArray(databucket.value)) {
                if (typeof requestBody === 'object' && requestBody != null) {
                    requestBody = Object.assign({ [routeCrudKey]: generateUUID() }, requestBody);
                }
