...
import { Environment, FakerAvailableLocales, ServerEvents } from '@mockoon/commons';
...
export declare class MockoonServer extends MockoonServer_base {
    ...
    constructor(environment: Environment, options?: {
        /**
     ...
     */
    private captureReferencedDatabucketIds;
    /**
