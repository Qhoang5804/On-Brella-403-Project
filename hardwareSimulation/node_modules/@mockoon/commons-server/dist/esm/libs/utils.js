import { Methods } from '@mockoon/commons';
 ...
 * @param method
 */
export function isBodySupportingMethod(method) {
 ...
 * @param responseBody
 */
export function CreateCallbackInvocation(callback, url, requestBody, requestHeaders, fetchResponse, responseBody) {
 ...
 * @returns object | null
 */
export const objectFromSafeString = (text) => {
    const parsedText = text instanceof SafeString ? text.toString() : text;
 ...
 * @returns
 */
export const preparePath = (endpointPrefix, endpoint) => dedupSlashes(`/${endpointPrefix}/${endpoint.replace(/ /g, '%20')}`);
/**
 ...
 * @returns
 */
export const fullTextSearch = (object, query) => {
    if (typeof object === 'object' || typeof object === 'boolean') {
        return Object.values(object !== null && object !== void 0 ? object : []).some((value) => fullTextSearch(value, query));
    }
 ...
 * @returns
 */
export const getValueFromPath = (data, path, defaultValue) => {
