...
const UUIDSchema = Joi.string()
    .uuid()
    .failover(() => (0, utils_1.generateUUID)())
    .required();
...
const RouteResponseRuleSchema = Joi.object({
    target: Joi.string()
        .valid('body', 'query', 'header', 'params', 'request_number', 'cookie', 'global_var')
...
const CallbackSchema = Joi.object({
    uuid: UUIDSchema,
    id: Joi.string().allow('').failover(exports.CallbackDefault.id).required(),
    name: Joi.string().default('').failover(exports.CallbackDefault.name).required(),
    documentation: Joi.string()
        .allow('')
        .failover(exports.CallbackDefault.documentation)
        .required(),
    method: Joi.string()
        ...
        .required(),
    uri: Joi.string().allow('').failover(exports.CallbackDefault.uri).required(),
    headers: Joi.array()
        .items(HeaderSchema, Joi.any().strip())
        .failover(exports.CallbackDefault.headers)
        .required(),
    body: Joi.string().allow('').failover(exports.CallbackDefault.body).required(),
    bodyType: Joi.string()
        .valid(route_model_1.BodyTypes.INLINE, route_model_1.BodyTypes.DATABUCKET, route_model_1.BodyTypes.FILE)
        .failover(exports.CallbackDefault.bodyType)
        .required(),
    filePath: Joi.string()
        .allow('')
        .failover(exports.CallbackDefault.filePath)
        .required(),
    sendFileAsBody: Joi.boolean()
        .failover(exports.CallbackDefault.sendFileAsBody)
        .required(),
    databucketID: Joi.string()
        .allow('')
        .failover(exports.CallbackDefault.databucketID)
        .required()
})
    .failover(exports.EnvironmentDefault.callbacks)
    .default(exports.EnvironmentDefault.callbacks)
    .options({ stripUnknown: true });
const CallbackInvocationSchema = Joi.object({
    uuid: UUIDSchema,
...
const RouteResponseSchema = Joi.object({
    ...
    crudKey: Joi.string().failover(exports.RouteResponseDefault.crudKey).required(),
    callbacks: Joi.array()
        .items(CallbackInvocationSchema, Joi.any().strip())
        .failover(exports.RouteResponseDefault.callbacks)
        .required()
});
