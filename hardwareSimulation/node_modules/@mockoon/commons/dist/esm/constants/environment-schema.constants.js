...
export const ResponseCallbackDefault = {
    uuid: '',
    latency: 0
};
...
export const RouteSchema = Joi.object({
    ...
    method: Joi.string()
        .allow('')
        .valid(Methods.all, Methods.get, Methods.post, Methods.put, Methods.patch, Methods.delete, Methods.head, Methods.options, Methods.propfind, Methods.proppatch, Methods.move, Methods.copy, Methods.mkcol, Methods.lock, Methods.unlock)
    ...
    responseMode: Joi.string()
        .allow(null)
        .valid(ResponseMode.RANDOM, ResponseMode.SEQUENTIAL, ResponseMode.DISABLE_RULES, ResponseMode.FALLBACK)
