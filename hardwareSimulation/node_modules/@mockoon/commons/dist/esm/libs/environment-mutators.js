 ...
 * @returns
 */
export const updateEnvironmentMutator = (environment, properties) => (Object.assign(Object.assign({}, environment), properties));
/**
 ...
 * @returns
 */
export const addRouteMutator = (environment, newRoute, parentId) => {
 ...
 * @returns
 */
export const updateRouteMutator = (environment, routeUuid, properties) => (Object.assign(Object.assign({}, environment), { routes: environment.routes.map((route) => {
 ...
 * @returns
 */
export const removeRouteMutator = (environment, routeUuid) => {
 ...
 * @returns
 */
export const reorderRoutesMutator = (environment, reorderAction) => {
    let newRootChildren = environment.rootChildren;
    let newFolders = environment.folders;
    ...
    if (reorderAction.reorderActionType === ReorderActionType.INSIDE &&
        ...
        if (reorderAction.targetParentId === 'root') {
            newRootChildren = insertItemAtTarget(newRootChildren, reorderAction.reorderActionType, {
                type: reorderAction.isSourceContainer ? 'folder' : 'route',
                uuid: reorderAction.sourceId
            ...
            newFolders = newFolders.map((folder) => {
                if (folder.uuid === reorderAction.targetParentId) {
                    return Object.assign(Object.assign({}, folder), { children: insertItemAtTarget(folder.children, reorderAction.reorderActionType, {
                            type: reorderAction.isSourceContainer ? 'folder' : 'route',
                            uuid: reorderAction.sourceId
                        }, reorderAction.targetId) });
                }
 ...
 * @returns
 */
export const reorderRouteResponseMutator = (environment, routeUuid, reorderAction) => (Object.assign(Object.assign({}, environment), { routes: environment.routes.map((route) => {
        if (route.uuid === routeUuid) {
            return Object.assign(Object.assign({}, route), { responses: moveItemAtTarget(route.responses, reorderAction.reorderActionType, reorderAction.sourceId, reorderAction.targetId) });
        }
        return route;
    }) }));
/**
 ...
 * @returns
 */
export const reorderDatabucketMutator = (environment, reorderAction) => (Object.assign(Object.assign({}, environment), { data: moveItemAtTarget(environment.data, reorderAction.reorderActionType, reorderAction.sourceId, reorderAction.targetId) }));
/**
 ...
 * @returns
 */
export const reorderCallbackMutator = (environment, reorderAction) => (Object.assign(Object.assign({}, environment), { callbacks: moveItemAtTarget(environment.callbacks, reorderAction.reorderActionType, reorderAction.sourceId, reorderAction.targetId) }));
/**
 ...
 * @returns
 */
export const addFolderMutator = (environment, newFolder, parentId) => {
    let rootChildren = environment.rootChildren;
    let folders = [...environment.folders];
 ...
 * @returns
 */
export const updateFolderMutator = (environment, folderUuid, properties) => (Object.assign(Object.assign({}, environment), { folders: environment.folders.map((folder) => {
 ...
 * @returns
 */
export const removeFolderMutator = (environment, folderUuid) => {
    var _a;
    const { children: folderChildren } = (_a = environment.folders.find((folder) => folder.uuid === folderUuid)) !== null && _a !== void 0 ? _a : { children: [] };
    let newFolders = environment.folders;
    let newRootChildren = environment.rootChildren;
    // parent is root level
 ...
 * @returns
 */
export const addDatabucketMutator = (environment, newDatabucket, insertAfterUuid) => {
 ...
 * @returns
 */
export const updateDatabucketMutator = (environment, databucketUuid, properties) => (Object.assign(Object.assign({}, environment), { data: environment.data.map((databucket) => {
 ...
 * @param databucketUuid
 */
export const removeDatabucketMutator = (environment, databucketUuid) => {
 ...
 * @returns
 */
export const addRouteResponseMutator = (environment, routeUuid, newRouteResponse, insertAfterUuid) => (Object.assign(Object.assign({}, environment), { routes: environment.routes.map((route) => {
        if (route.uuid === routeUuid) {
 ...
 * @returns
 */
export const updateRouteResponseMutator = (environment, routeUuid, routeResponseUuid, properties) => (Object.assign(Object.assign({}, environment), { routes: environment.routes.map((route) => {
        if (route.uuid === routeUuid) {
 ...
 * @param routeResponseUuid
 */
export const removeRouteResponseMutator = (environment, routeUuid, routeResponseUuid) => (Object.assign(Object.assign({}, environment), { routes: environment.routes.map((route) => {
        if (route.uuid === routeUuid) {
 ...
 * @param insertAfterUuid
 */
export const addCallbackMutator = (environment, newCallback, insertAfterUuid) => {
 ...
 * @returns
 */
export const updateCallbackMutator = (environment, callbackUuid, properties) => (Object.assign(Object.assign({}, environment), { callbacks: environment.callbacks.map((callback) => {
 ...
 * @returns
 */
export const removeCallbackMutator = (environment, callbackUuid) => (Object.assign(Object.assign({}, environment), { callbacks: environment.callbacks.filter((callback) => callback.uuid !== callbackUuid), routes: environment.routes.map((route) => {
        let needsUpdate = false;
        const newReponses = route.responses.map((response) => {
