...
export declare const RulesDisablingResponseModes: ResponseMode[];
export declare const RulesNotUsingDefaultResponse: ResponseMode[];
...
export type ResponseRuleTargets = 'body' | 'query' | 'header' | 'params' | 'request_number' | 'cookie' | 'global_var';
